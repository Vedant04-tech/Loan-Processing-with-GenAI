...
from .schemas import AnomalyAssessment, ClassifiedAnomaly, Discrepancy
...
def classify_anomalies_with_llm(
    ...
    if not discrepancies:
        return AnomalyAssessment(
            anomalies=[],
            underwriting_summary="All document checks and calculations verified without discrepancies.",
            suggested_actions=["Confirm applicant identity match across KYC proofs", "Verify one-click fast-track sign-off for loan disbursement"]
        ), False
